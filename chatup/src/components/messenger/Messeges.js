    ...
    <>
      <div>
        <div id="chats" className={me ? "m-1 flex justify-end" : "m-1 flex"}>
          ...
          <div>
            <h1 className={me ? "flex text-gray-700 bg-gray-300 p-2 max-w-xs rounded-xl rounded-tl-none text-sm" 
            : "flex text-white  bg-blue-700 p-2 max-w-xs rounded-xl rounded-tl-none text-sm"}>
